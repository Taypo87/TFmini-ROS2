...
namespace benewake
{
    ...
    portName_(_name), baudRate_(_baudRate)
  {
    ...
    if (serial_ == -1)
    {
      RCLCPP_ERROR_STREAM("Failed to open serial port!");
      exit(0);
    }
    ...
    {
      RCLCPP_ERROR_STREAM("Can't get serial port sets!");
      exit(0);
    }
    ...
    switch (_baudRate)
    {
      ...
      case 4800:
        ...
        break;
      default:
        RCLCPP_ERROR_STREAM("Unsupported baud rate!");
        exit(0);
    }
    ...
    {
      RCLCPP_ERROR_STREAM("Can't set serial port options!");
      exit(0);
    }
  }
